...
<div class="bg-light py-3">
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <div class="block-16">
            <figure>
                <img src="{{asset('assets/website/images/blog_1.jpg')}}" alt="Image placeholder" class="img-fluid rounded">
    ...
    <div class="container">
        ...
        <div class="col-md-6 col-lg-3">
            ...
            <div class="block-38-img">
                ...
                <img src="{{asset('assets/website/images/person_1.jpg')}}" alt="Image placeholder" class="mb-4">
        ...
        <div class="col-md-6 col-lg-3">
            ...
            <div class="block-38-img">
                <div class="block-38-header">
                <img src="{{asset('assets/website/images/person_2.jpg')}}" alt="Image placeholder" class="mb-4">
        ...
        <div class="col-md-6 col-lg-3">
            ...
            <div class="block-38-img">
                <div class="block-38-header">
                <img src="{{asset('assets/website/images/person_3.jpg')}}" alt="Image placeholder" class="mb-4">
        ...
        <div class="col-md-6 col-lg-3">
            ...
            <div class="block-38-img">
                <div class="block-38-header">
                <img src="{{asset('assets/website/images/person_4.jpg')}}" alt="Image placeholder" class="mb-4">
